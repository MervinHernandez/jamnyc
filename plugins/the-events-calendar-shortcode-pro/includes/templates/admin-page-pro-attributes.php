...
<p></p><?php echo sprintf( esc_html( __( 'or you can specify either the from or the to date, and optionally add %s to only show future events', 'the-events-calendar-shortcode' ) ), 'futureonly' ); ?>
